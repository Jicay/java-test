...
java -jar /app/setup/lib/junit-platform-console-standalone-1.8.2.jar --details=tree -cp /app/setup/lib/junit-jupiter-engine-5.8.2.jar:/app/setup/lib/assertj-core-3.22.0.jar:build --scan-classpath --disable-banner