...
class SortTest {
    ...
    void sort() {
        ...
        List<Integer> res = Sort.sort(list);
    ...
    void sort_shouldReturnEmpty_whenEmpty() {
        List<Integer> res = Sort.sort(List.of());
    ...
    void sort_shouldReturnNull_whenNull() {
        List<Integer> res = Sort.sort(null);
    ...
    void sortReverse() {
        ...
        List<Integer> res = Sort.sortReverse(list);
    ...
    void sortReverse_shouldReturnEmpty_whenEmpty() {
        List<Integer> res = Sort.sortReverse(List.of());
    ...
    void sortReverse_shouldReturnNull_whenNull() {
        List<Integer> res = Sort.sortReverse(null);
