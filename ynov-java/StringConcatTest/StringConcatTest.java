...
class StringConcatTest {
    ...
    void concat_withBothStringsFilled() {
        ...
        assertThat(res)
                .withFailMessage("Should return \"Ynov Bordeaux\" for concatenation of \"Ynov \" and \"Bordeaux\" strings, %s was returned", res)
    ...
    void concat_withFirstEmpty() {
        ...
        assertThat(res)
                .withFailMessage("Should return \"il fait beau\" for concatenation of \"\" and \"il fait beau\" strings, %s was returned", res)
    ...
    void concat_withFirstNull() {
        ...
        assertThat(res)
                .withFailMessage("Should return \"il pleut\" for concatenation of null and \"il pleut\" strings, %s was returned", res)
                .isEqualTo("il pleut");
    }
    ...
    void concat_withSecondEmpty() {
        ...
        assertThat(res)
                .withFailMessage("Should return \"Bonjour les gens\" for concatenation of \"Bonjour les gens\" and \"\" strings, %s was returned", res)
    ...
    void concat_withSecondNull() {
        ...
        assertThat(res)
                .withFailMessage("Should return \"Hello World\" for concatenation of \"Hello World\" and null strings, %s was returned", res)
